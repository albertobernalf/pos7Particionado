...
let dataTableOrdenadosApoyoTerapeuticoInitialized = false;
let dataTableNoOrdenadosApoyoTerapeuticoInitialized = false;
  ...
  lengthMenu: [2, 4, 15],
...

	{
	  ...
	  initComplete: function(settings, json) {
		...
		var primeraFila = $('#tablaApoyoTerapeutico tbody tr:eq(0) input[type="radio"]').prop('checked', true);
             $(primeraFila).click();
...

	{
	  "render": function ( data, type, row ) {
                        var btn = '';
                         ...
                         btn = btn + " <input type='radio'  class='form-check-input editPostOrdenadosApoyoTerapeutico' data-pk='" + row.pk + "'>" + "</input>";
	        ...
	        dataTable = $('#tablaOrdenadosApoyoTerapeutico').DataTable(dataTableOptionsOrdenadosApoyoTerapeutico);
