  ...
  lengthMenu: [2, 4, 15],
	...
	{"render": function ( data, type, row ) {
		...
		{"render": function ( data, type, row ) {
		 ...
		 btn = btn + " <button class='ImprimirEpicrisis btn-primary ' data-pk='" + row.pk + "'>" + '<i class="fa-duotone fa-solid fa-print"></i>' + "</button>";
                       return btn;
                    },
	  ...
	  initComplete: function(settings, json) {
		// var primeraFila = $('#tablaClinico').row(':eq(0)').node();
		var primeraFila = $('#tablaClinico tbody tr:eq(0) input[type="radio"]').prop('checked', true);
             $(primeraFila).click();
...
$.ajax({
    ...
    data : {ingresoId:ingresoId, flag:0,desdeFolio:0,hastaFolio:10000000},
    method: 'POST',
    xhrFields: {
...
$('#tablaClinico tbody').on('click', '.ImprimirEpicrisis', function() {

	alert ("Entre tablaClinico Imprimir Epicrisis");
...
$.ajax({
    url: '/imprimirHistoriaClinica/',
 data : {ingresoId:ingresoId, flag:1,desdeFolio:0,hastaFolio:0},
    method: 'POST',
    xhrFields: {
        responseType: 'blob' // Importante: interpreta la respuesta como binario
    },
...
$('#tablaClinico tbody').on('click', '.ImprimirRangodeFolios', function() {

	alert ("Entre tablaClinico Imprimir Rango de Folios");
...
$.ajax({
    url: '/imprimirHistoriaClinica/',
 data : {ingresoId:ingresoId, flag:2,desdeFolio:desdeFolio,hastaFolio:hastaFolio},
    method: 'POST',
    xhrFields: {
        responseType: 'blob' // Importante: interpreta la respuesta como binario
    },
