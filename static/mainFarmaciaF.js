...

{
	  ...
	  initComplete: function(settings, json) {
		...
		var primeraFila = $('#tablaPanelFarmacia tbody tr:eq(0) input[type="radio"]').prop('checked', true);
             $(primeraFila).click();
    ...
    if (valorTabla == 2) // creo No existe
    {
	...
	},
{
	  ...
	  initComplete: function(settings, json) {
		...
		var primeraFila = $('#tablaFarmaciaDetalle tbody tr:eq(0) input[type="radio"]').eq(1).prop('checked', true);
            // $(primeraFila).click();
                 primeraFila.addClass('selected');
        }
            }
...
$('#tablaPanelFarmacia tbody').on('click', '.miSelFarmacia', function() {
	 ...
	 alert("ENTRE miSelFarmacia" +   farmaciaId);
	...
	data['farmaciaDetalleId'] = farmaciaDetalleId;
     ...
     $.ajax({
		...
		document.getElementById("habitacionDev").innerHTML = info[0].fields.cama;
	     ...
	     alert( " Voy a cargar farmacia detalle");
...
$('#tablaFarmaciaDetalle tbody').on('click', '.miFarmaciaDetalle', function() {
		...
		alert("click en  farmaciaDetalleId = " +  farmaciaDetalleId);
...
var row = $(this).closest('tr'); // Encuentra la fila
	var table = $('#tablaFarmaciaDetalle').DataTable();  // Inicializa el DataTable jquery//
 	...
 	var rowindex = table.row(row).data(); // Obtiene los datos de la fila
       console.log("rowindex= " , rowindex);
	    	 ...
	    	 dato1 = Object.values(rowindex);
		console.log(" fila seleccionada de farmaciaDetalle con datos: = ",  dato1);
	        dato3 = dato1[2];
 ...
 document.getElementById("medicamentoDE").innerHTML = dato3.medicamento;
 document.getElementById("dosisDE").innerHTML = dato3.dosis;
 document.getElementById("medidaDE").innerHTML = dato3.medida;
 document.getElementById("frecuenciaDE").innerHTML = dato3.frecuencia;
 document.getElementById("viaDE").innerHTML = dato3.via;
 document.getElementById("cantidadDE").innerHTML = dato3.cantidad
	...
	data['farmaciaId'] = farmaciaId;
 	    data = JSON.stringify(data);
    alert("voy a levantar la tabla despachos dipspensa");
...
$('#tablaFarmaciaDetalle tbody').on('click', '.miDispensaFarmacia', function() {
		...
		farmaciaDetalleId =   post_id;
		 ...
		 $('#postFormDispensaFarmacia').trigger("reset");
		document.getElementById("servicioAdmonEntregaF").value  ="";
		document.getElementById("plantaEntregaF").value  ="";
		document.getElementById("servicioAdmonRecibeF").value  ="";
		document.getElementById("plantaRecibeF").value  ="";
		document.getElementById("medicamentos").value  ="";
		document.getElementById("dosis").value  ="";
		document.getElementById("uMedidaDosis").value  ="";
...
$('#tablaDespachosFarmacia tbody').on('click', '.miDespachoFarmacia2', function() {
	...
	data['despachoId'] = despachoId;
        ...
        $('body').on('click', '.miImprimirDespacho', function () {
...
//
//    error: function (error) {
//	alert("me devolvi con error" + JSON.stringify(error));
//
//      document.getElementById("mensajesError").value =  data.responseText;
//    }
// });
...
function AdicionarDespachosDispensa()
{
  ...
  $.ajax({
	 ...
	 dataTableDespachosFarmaciaInitialized = true;
   	...
   	alert("Voy a inicializar la tabla de formulacion .." );
   	...
   	alert("Voy a inicializar los combos de entregas-recibos de medicamento ..." );
    	...
    	alert("Modal a cerrar" );
         $('#crearModelDispensaFarmacia').modal('hide');
	alert("En teoria ya cerre la modal... " );
