  ...
  lengthMenu: [2, 4, 15],
              ...
              /*  { data: "fields.id"}, */
	{
	  ...
	  initComplete: function(settings, json) {
		...
		var primeraFila = $('#tablaCartera tbody tr:eq(0) input[type="radio"]').prop('checked', true);
             $(primeraFila).click();
  ...
  lengthMenu: [2, 4, 15],
	 ...
	 pageLength: 3,
	  ...
	  initComplete: function(settings, json) {
		...
		var primeraFila = $('#tablaPagosEmpresas tbody tr:eq(0) input[type="radio"]').prop('checked', true);
             $(primeraFila).click();
                 primeraFila.addClass('selected');
        }
            }
  ...
  lengthMenu: [2, 4, 15],
	 ...
	 pageLength: 3,
	  ...
	  initComplete: function(settings, json) {
		...
		var primeraFila = $('#tablaEmpresas tbody tr:eq(0) input[type="radio"]').prop('checked', true);
             $(primeraFila).click();
                 primeraFila.addClass('selected');
        }
            }
