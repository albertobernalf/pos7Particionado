...
urlpatterns = [
    ...
    #url(r'^furips/', include('admisiones.urls', namespace='furips')),
    ...
    path('leerJson/', viewsFacturacion.LeerJson , name='Leer_json'),
    ...
    path('guardarRespuestaXml/', viewsFacturacion.GuardarRespuestaXml , name='GuardarRespuesta_Xml'),

    path('api/factura/enviar/', viewsFacturacion.EnviarFacturaDianView.as_view(), name='enviar_factura_dian'),
    ...
    path('reversarEnvioRips/', viewsRips.ReversarEnvioRips, name='reversarEnvio_Rips'),
    ...
    path('traerCodigoTipoNota/', viewsCartera.TraerCodigoTipoNota, name='traerCodigo_TipoNota'),
    path('load_dataNotas/<str:data>', viewsCartera.Load_dataNotas, name= 'loaddata_Notas'),
    path('guardaNotasCreditoDetalleAdicionar/', viewsCartera.GuardaNotasCreditoDetalleAdicionar, name='guardaNotasCredito_DetalleAdicionar'),
    path('load_dataNotasCreditoDetalle/<str:data>', viewsCartera.load_dataNotasCreditoDetalle, name= 'load_dataNotasCreditoDetalle'),
    ...
    path('borraGlosasDetalleRips/', viewsCartera.BorraGlosasDetalleRips, name='BorraGlosas_DetalleRips'),
    ...
    path('load_dataDispoSalasCirugia/<str:data>', viewsCirugia.Load_dataDispoSalasCirugia,name='load_dataDispo_SalasCirugia'),
    ...
    path('imprimirDespFarma/', viewsFarmaciaReportes.ImprimirDespacho),
