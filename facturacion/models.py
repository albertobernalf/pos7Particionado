...
class Empresas (models.Model):
    ...
    ciudad  = models.ForeignKey('sitios.Ciudades', blank=True,null= True, editable=True,  on_delete=models.PROTECT , related_name='Ciudada0001')
    ...
    contacto = models.CharField(max_length=150, blank=True,null= True, editable=True,)
    correo = models.EmailField( blank=True,null= True, editable=True)
    fechaRegistro = models.DateTimeField(default=now, blank=True,null= True, editable=True, )
    estadoReg = models.CharField(max_length=1,choices=ESTADOREG_CHOICES,  default='A', editable=False)
...
#class Facturacion(PostgresPartitionedModel):
    ...
    prefijo = models.CharField(max_length=20, blank=True,null= True, editable=True,)
    ...
    cufeDefinitivo =  models.CharField(max_length=1000, blank=True,null= True, editable=True,)
    cufeValor =  models.CharField(max_length=1000, blank=True,null= True, editable=True,)
    #cufeValor =   models.DecimalField( max_digits=15, decimal_places=2 , blank=True,null= True, editable=True)
    rutaCufe =  models.CharField(max_length=2000, blank=True,null= True, editable=True,)
    codigoQr = models.CharField(max_length=1000, blank=True,null= True, editable=True,)
    rutaQr =  models.CharField(max_length=2000, blank=True,null= True, editable=True,)
    rutaJson = models.CharField(max_length=400, blank=True,null= True, editable=True,)
    rutaXml = models.CharField(max_length=400, blank=True,null= True, editable=True,)
    ...
    rutaPdf = models.CharField(max_length=1000, blank=True,null= True, editable=True,)
    ...
    totalOtrasNotasCredito =models.DecimalField( max_digits=15, decimal_places=2 , blank=True,null= True, editable=True)
...
class ConsecutivosDian(models.Model):
    ESTADOREG_CHOICES = [
        ('A', 'Activo'),
        ('I', 'Inactivo'), ]
    id = models.AutoField(primary_key=True)
    resolucion = models.CharField(max_length=150, blank=True,null= True, editable=True,)
    prefijoDian = models.ForeignKey('facturacion.PrefijosDian',   blank=True,null= True, on_delete=models.PROTECT ,related_name ='prefijodian667')
    desde = models.DecimalField( max_digits=15, decimal_places=0 , blank=True,null= True, editable=True)
    hasta = models.DecimalField( max_digits=15, decimal_places=0 , blank=True,null= True, editable=True)
    actual = models.DecimalField( max_digits=15, decimal_places=0 , blank=True,null= True, editable=True)
    fechaRegistro = models.DateTimeField(default=now, blank=True, null=True, editable=True, )
    estadoReg = models.CharField(max_length=1,choices=ESTADOREG_CHOICES,  default='A', editable=False)
...
class PrefijosDian(models.Model):
    ESTADOREG_CHOICES = [
        ('A', 'Activo'),
        ('I', 'Inactivo'), ]
    id = models.AutoField(primary_key=True)
    sedesClinica = models.ForeignKey('sitios.SedesClinica',   blank=True,null= True, on_delete=models.PROTECT ,related_name ='sedesClinica5589')
    #resolucion = models.CharField(max_length=150, blank=True,null= True, editable=True,)
    prefijoDian = models.CharField(max_length=20, blank=True,null= True, editable=True,)
