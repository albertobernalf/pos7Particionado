...
class FormasPagos(models.Model):
    ...
    codigoRips = models.ForeignKey('rips.RipsTiposPagoModerador', blank=True,null= True, editable=True, on_delete=models.PROTECT, related_name = 'tiposPagosMod7645')
...
class Glosas(models.Model):
    ...
    tiposNota = models.ForeignKey('cartera.TiposNotas',blank=True,null= True, editable=True, on_delete=models.PROTECT ,  related_name='tiposNotasGlosa01')
...
class NotasCredito(models.Model):
    ...
    #ripsId    =  models.IntegerField(editable=True, null=True, blank=True)
    valorNotaTotal =  models.DecimalField( max_digits=15, decimal_places=2)
    cufeDef =  models.CharField(max_length=5000,  blank=True, null=True, editable=True)
    cufeVr =  models.CharField(max_length=5000, blank=True, null=True, editable=True)
    codQr=  models.CharField(max_length=5000,  blank=True, null=True, editable=True)
    rutaQr = models.CharField(max_length=5000,  blank=True, null=True, editable=True)
    ...
    trackId =models.CharField(max_length=5000,  blank=True, null=True, editable=True)
    rutaXmlRespuesta = models.CharField(max_length=5000,  blank=True, null=True, editable=True)
    estadoRecepcion = models.ForeignKey('cartera.EstadosGlosas',blank=True,null= True, editable=True, on_delete=models.PROTECT ,  related_name='estadoNotaCredito01')
    estadoRadicacion = models.ForeignKey('cartera.EstadosGlosas',blank=True,null= True, editable=True, on_delete=models.PROTECT ,  related_name='estadoNotaCredito02')
    ...
    codigoZip = models.IntegerField(editable=True, null=True, blank=True)
    tiposNota = models.ForeignKey('cartera.TiposNotas',blank=True,null= True, editable=True, on_delete=models.PROTECT ,  related_name='tiposNotasCredito01')
    #estadoNotaCredito = models.ForeignKey('cartera.EstadosGlosas',blank=True,null= True, editable=True, on_delete=models.PROTECT ,  related_name='estadoNotasCredito01')
    fechaRecepcion = models.DateTimeField(editable=True, null=True, blank=True)
    fechaRespuesta = models.DateTimeField(editable=True, null=True, blank=True)
    usuarioRespuesta = models.ForeignKey('planta.Planta', editable=True, null=True, blank=True, on_delete=models.PROTECT,   related_name='respuesta15')
    usuarioRecepcion = models.ForeignKey('planta.Planta',editable=True, null=True, blank=True, on_delete=models.PROTECT,   related_name='recepcion16')
...
class PagosEmpresas(models.Model):
    ...
    radicado = models.CharField(max_length=20, editable=False)
