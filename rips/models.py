...
class RipsUsuarios (models.Model):
    ...
    def __str__(self):
        return self.numDocumentoIdentificacion 
...
class RipsMedicamentos(models.Model):
   ...
   vrServicio = models.DecimalField(max_digits=15, decimal_places=2, blank=True,null= True, editable=True)
   tipoPagoModerador =  models.ForeignKey('rips.RipsTiposPagoModerador', blank=True, null=True, editable=True, on_delete=models.PROTECT, related_name='modera0122')
