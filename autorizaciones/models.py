...
class Autorizaciones(models.Model):
    ...
    ingreso =  models.ForeignKey('admisiones.Ingresos',  blank=True, null=True, editable=True, on_delete=models.PROTECT,   related_name='adm1476')  
    triage =  models.ForeignKey('triage.Triage',  blank=True, null=True, editable=True, on_delete=models.PROTECT,   related_name='Triage1476')  
...
class AutorizacionesDetalle(models.Model):
    ...
    cirugia = models.ForeignKey('cirugia.Cirugias', blank=True,null= True, editable=True, on_delete=models.PROTECT, related_name = 'CiruAut0001')
    fechaRegistro = models.DateTimeField(default=now, blank=True,null= True, editable=True, )
