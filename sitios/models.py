...
class Departamentos(models.Model):
    ...
    departamentoCodigoDian = models.CharField(max_length=15,  blank=True,null= True, editable=True)
...
class Ciudades(models.Model):
        ...
        nombre = models.CharField(max_length=50)
        ciudadCodigoDian = models.CharField(max_length=15,blank=True, null=True,editable=True)
        fechaRegistro = models.DateTimeField(default=now, editable=False)
        estadoReg = models.CharField(max_length=1, choices=ESTADOREG_CHOICES,default='A', editable=False)
...
class SedesClinica(models.Model):
    ...
    prefijoDian = models.ForeignKey('facturacion.PrefijosDian', blank=True,null= True, editable=True, on_delete=models.PROTECT)
    empresa = models.ForeignKey('facturacion.Empresas', blank=True,null= True, editable=True, on_delete=models.PROTECT,  related_name = 'empre99')
    fechaRegistro = models.DateTimeField(default=now, editable=False)
    estadoReg = models.CharField(max_length=1,choices=ESTADOREG_CHOICES, default='A', editable=False)
...
class Municipios(models.Model):
    ...
    id = models.AutoField(primary_key=True)
    nombre = models.CharField(max_length=50)
    municipioCodigoDian = models.CharField(max_length=15,blank=True,null= True, editable=True)
