    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estadoreg', models.CharField(choices=[('A', 'Activo'), ('I', 'Inactivo')], default='A', max_length=1)),
                ('mae_gruporeportes', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='Administracion.mae_gruporeportes')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estadoreg', models.CharField(choices=[('A', 'Activo'), ('I', 'Inactivo')], default='A', max_length=1)),
                ('mae_reportes', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='Administracion.mae_reportes')),
            ],
        ),
    ]
